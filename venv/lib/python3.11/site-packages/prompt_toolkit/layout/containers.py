...
(Containers can contain other containers or users interface controls.)
"""
...
class Container(metaclass=ABCMeta):
    """
    Base class for users interface layout.
    """
    ...
    def is_modal(self) -> bool:
        ...
        not taken into account if a users control in this container is focused.
        """
        return False
    ...
    def get_key_bindings(self) -> KeyBindingsBase | None:
        ...
        users control in this container has the focus, except if any containers
        between this container and the focused users control is modal.
        """
        return None
...
class WindowRenderInfo:
    ...
    def content_height(self) -> int:
        """
        The full height of the users control.
        """
...
class Window(Container):
    ...
    :param always_hide_cursor: A `bool` or
        ...
        when the users control specifies a cursor position.
    ...
    def write_to_screen(
        ...
        """
        Write window to screen. This renders the users control, the margins and
    ...
    def _write_to_screen_at_index(
        ...
        # Tell the screen that this users control has been painted at this
        # position.
    ...
    def _apply_style(
        ...
        # be used to apply an 'underline' to the users control.
        wp = WritePosition(
            write_position.xpos,
    ...
    def _show_key_processor_key_buffer(self, new_screen: Screen) -> None:
        """
        When the users is typing a key binding that consists of several keys,
        display the last pressed key if the users is in insert mode and the key
