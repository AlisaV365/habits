...
class UIControl(metaclass=ABCMeta):
    """
    Base class for all users interface controls.
    """
    ...
    def is_focusable(self) -> bool:
        """
        Tell whether this users control is focusable.
        """
        return False
    ...
    def create_content(self, width: int, height: int) -> UIContent:
        """
        Generate the content for this users control.
    ...
    def get_key_bindings(self) -> KeyBindingsBase | None:
        """
        The key bindings that are specific for this users control.
...
class UIContent:
    """
    Content generated by a users control. This content consists of a list of
    lines.
...
class FormattedTextControl(UIControl):
    ...
    Mouse support:
        ...
        (style_str, text, handler). When mouse support is enabled and the users
    ...
    def mouse_handler(self, mouse_event: MouseEvent) -> NotImplementedOrNone:
        ...
        (When the fragment list contained mouse handlers and the users clicked on
...
class BufferControl(UIControl):
    ...
    def create_content(
        ...
        # we're sure the right event loop is active, and don't require users
