...
class Application(Generic[_AppResult]):
    ...
    def __init__(
        ...
        # case of full screen applications only. This can be overridden by the users.
    ...
    def _create_merged_style(self, include_default_pygments_style: Filter) -> BaseStyle:
        ...
        pygments style, and the custom users style.
        """
    ...
    async def run_async(
        ...
        :param set_exception_handler: When set, in case of an exception, go out
            ...
            exception, and wait for the users to press ENTER.
    ...
    async def run_system_command(
        ...
        :param wait_for_enter: FWait for the users to press enter, when the
            command is finished.
        ...
        async with in_terminal():
            ...
            # Wait for the users to press enter.
            if wait_for_enter:
...
class _CombinedRegistry(KeyBindingsBase):
    ...
    This merges the global key bindings with the one of the current users
    control.
    """
