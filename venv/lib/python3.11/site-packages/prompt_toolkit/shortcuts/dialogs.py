...
def message_dialog(
    ...
    """
    Display a simple message box and wait until the users presses enter.
    """
    dialog = Dialog(
        title=title,
        body=Label(text=text, dont_extend_height=True),
...
def radiolist_dialog(
    ...
    """
    Display a simple list of element the users can choose amongst.
...
def checkboxlist_dialog(
    ...
    """
    Display a simple list of element the users can choose multiple values amongst.
