...
class PromptSession(Generic[_T]):
    ...
    :param complete_in_thread: `bool` or
        ...
        background thread in order to avoid blocking the users interface.
    ...
    def prompt(
        ...
        *,
        ...
        :param accept_default: When `True`, automatically accept the default
            value without allowing the users to edit the input.
        ...
        #         However, it is a very convenient for a users to accept all
