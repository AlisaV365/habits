...
class Buffer:
    ...
    :param accept_handler: Called when the buffer input is accepted. (Usually
        when the users presses `enter`.) The accept handler receives this
    ...
    def reset(
        ...
        #: modified. The users can press arrow_up and edit previous entries.
    ...
    def _create_completer_coroutine(self) -> Callable[..., Coroutine[Any, Any, None]]:
        ...
        async def async_completer(
            ...
            if proceed():
                # When no completions were found, or when the users selected
