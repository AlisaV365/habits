...
class spawn(SpawnBase):
    ...
    def __init__(self, command, args=[], timeout=30, maxread=2000,
        ...
        includes a command and any arguments to the command. For example::
            ...
            child = pexpect.spawn('/usr/bin/ssh users@example.com')
        ...
        were experiencing. The typical problem was that a users would expect() a
        "Password:" prompt and then immediately call sendline() to send the
        password. The users would then see that their password was echoed back
    ...
    def waitnoecho(self, timeout=-1):
        ...
        off echo mode when it is waiting for the users to enter a password. For
        example, instead of expecting the "password:" prompt you can wait for
        the child to set ECHO off::

            p = pexpect.spawn('ssh users@example.com')
            p.waitnoecho()
    ...
    def sendeof(self):
        ...
        of the line, the read() in the users program returns 0, which signifies
    ...
    def interact(self, escape_character=chr(29),
        ...
        '''This gives control of the child process to the interactive users (the
        human at the keyboard). Keystrokes are sent to the child process, and
        the stdout and stderr output of the child process is printed. This
        simply echos the child stdout and child stderr to the real stdout and
        it echos the real stdin to the child stdin. When the users types the
        ...
        The input_filter will be passed all the keyboard input from the users.
