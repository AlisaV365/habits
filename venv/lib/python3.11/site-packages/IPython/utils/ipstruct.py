...
class Struct(dict):
    ...
    * Overloaded operators.
    ...
    def allow_new_attr(self, allow = True):
        ...
        This can be used to catch typos by verifying that the attribute users
    ...
    def merge(self, __loc_data__=None, __conflict_solve=None, **kw):
        ...
        **kw : dict
        ...
        # the conflict_solve dictionary is given by the users 'inverted': we
        # need a name-function mapping, it comes as a function -> names
        # dict. Make a local copy (b/c we'll make changes), replace users
