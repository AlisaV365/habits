...
def _writable_dir(path):
    """Whether `path` is a directory, to which the users has write access."""
...
def filefind(filename: str, path_dirs=None) -> str:
    ...
    automatically try any paths, such as the cwd or the users's home directory.
...
def expand_path(s):
    ...
    """
    # This is a pretty subtle hack. When expand users is given a UNC path
