...
if resource is not None and hasattr(resource, "getrusage"):
    ...
    def clock2():
        ...
        Similar to clock(), but return a tuple of users/system times."""
        return resource.getrusage(resource.RUSAGE_SELF)[:2]

else:
    # There is no distinction of users/system time under windows, so we just use
...
def timings_out(reps,func,*args,**kw):
    ...
    Under Unix, the return value is the sum of users+system time consumed by
