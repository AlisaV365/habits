...
def embed_kernel(module=None, local_ns=None, **kwargs):
    ...
    local_ns : dict, optional
        The namespace to load into IPython users namespace (default: caller)
...
def start_ipython(argv=None, **kwargs):
    ...
    user_ns : dict, optional
        specify this dictionary to initialize the IPython users namespace with particular values.
    **kwargs : various, optional
