...
# ipython ip.db database (kept in the users's .ipython dir).
TIMEOUT_STORAGE = 2
...
def module_completer(self,event):
    """Give completions after users has typed 'import ...' or 'from ...'"""
...
def magic_run_completer(self, event):
    ...
    # Find if the users has already typed the first filename, after which we
