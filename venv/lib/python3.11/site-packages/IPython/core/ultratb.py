...
# formatter.  When running in an actual IPython instance, the users's rc.colors
...
class VerboseTB(TBTools):
    ...
    def __init__(
        ...
        # By default we use linecache.checkcache, but the users can provide a
