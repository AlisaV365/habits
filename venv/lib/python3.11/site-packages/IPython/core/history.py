...
class HistoryAccessor(HistoryAccessorBase):
    ...
    def get_tail(self, n=10, raw=True, output=False, include_latest=False):
        ...
        include_latest : bool
            ...
            is called by a users command, which it should not return.
...
class HistoryManager(HistoryAccessor):
    ...
    # Private interface
    # Variables used to store the three last inputs from the users.  On each new
    # history update, we populate the users's namespace with these, shifted as
    # necessary.
    _i00 = Unicode(u'')
    _i = Unicode(u'')
    _ii = Unicode(u'')
    ...
    def store_inputs(self, line_num, source, source_raw=None):
        ...
        # hackish access to users namespace to create _i1,_i2... dynamically
        new_i = '_i%s' % line_num
        to_main = {'_i': self._i,
                   '_ii': self._ii,
                   '_iii': self._iii,
