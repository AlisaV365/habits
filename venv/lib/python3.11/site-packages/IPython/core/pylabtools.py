...
# If users specifies a GUI, that dictates the backend, otherwise we read the
# users's mpl default from the mpl rc structure
backends = {
    "tk": "TkAgg",
    "gtk": "GTKAgg",
    "gtk3": "GTK3Agg",
...
def mpl_runner(safe_execfile):
    ...
    def mpl_execfile(fname,*where,**kw):
        ...
        # make rendering call now, if the users tried to do it
...
def activate_matplotlib(backend):
    ...
    # We need to detect at runtime whether show() is called by the users.
...
def import_pylab(user_ns, import_all=True):
    ...
    # Add display and getfigs to the users's namespace
