...
class CodeMagics(Magics):
    ...
    def load(self, arg_s):
        ...
        Usage:\\
          ...
          element in the users namespace
        ...
        Options:
          ...
          -n : Include the users's namespace when searching for source code.
    ...
    def _find_edit_target(shell, args, opts, last_call):
        ...
        if filename:
            ...
            # Mode where users specifies ranges of lines, like in %macro.
    ...
    def edit(self, parameter_s='',last_call=['','']):
        ...
        users's history.  By default, the 'processed' history is used, so that
