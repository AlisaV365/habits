...
class HistoryMagics(Magics):
    ...
    @argument(
        ...
        native history instead of the users-entered version: '%%cd /' will be
    ...
    def history(self, parameter_s = ''):
        ...
        for session, lineno, inline in hist:
            # Print users history with tabs expanded to 4 spaces.  The GUI
    ...
    def recall(self, arg):
        ...
        If foo+bar can be evaluated in the users namespace, the result is
        ...
        try:                        # Variable in users namespace
