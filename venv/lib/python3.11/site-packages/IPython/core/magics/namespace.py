...
class NamespaceMagics(Magics):
    """Magics to manage various aspects of the users's namespace.
    ...
    def pinfo(self, parameter_s='', namespaces=None):
        ...
        # happen if the users types 'pinfo foo?' at the cmd line.
    ...
    def psearch(self, parameter_s=''):
        ...
        Options:
          ...
          'builtin', 'users', 'user_global','internal', 'alias', where
          'builtin' and 'users' are the search defaults.  Note that you should
          not use quotes when specifying namespaces.

          -l: List all available object types for object matching. This function
          can be used without arguments.

          'Builtin' contains the python module builtin, 'users' contains all
          users data, 'alias' only contain the shell aliases and no python
        ...
        # Build list of namespaces to search from users options
    ...
    def reset(self, parameter_s=''):
        """Resets the namespace by removing all names defined by the users, if
    ...
    def reset_selective(self, parameter_s=''):
        """Resets the namespace by removing names defined by the users.
    ...
    def xdel(self, parameter_s=''):
        ...
        the identity of the named object in the users namespace to remove
