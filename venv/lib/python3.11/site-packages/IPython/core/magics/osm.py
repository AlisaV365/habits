...
class OSMagics(Magics):
    ...
    def set_env(self, parameter_s):
        ...
        name in the users namespace, or val is something that evaluates to a
        string.
        ...
        if re.match(r'.*\s.*', var):
            ...
            # not what the users intended.  what's more likely is the wrong
    ...
    def sc(self, parameter_s=''):
        ...
        will then update the users's interactive namespace with a variable
