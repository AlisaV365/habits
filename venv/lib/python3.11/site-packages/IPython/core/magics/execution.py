...
class ExecutionMagics(Magics):
    ...
    def __init__(self, shell):
        ...
        # Default execution function used to actually run users code.
    ...
    def debug(self, line="", cell=None, local_ns=None):
        ...
        .. versionchanged:: 7.3
            When running code, users variables are no longer expanded,
            the magic line is always left unmodified.
    ...
    def run(self, parameter_s='', runner=None,
        ...
        tilde '~' will be expanded into users's home directory.  Unlike
        ...
        *two* back slashes (e.g. ``\\\\*``) to suppress expansions.
        ...
        if 'i' in opts:
            # Run in users's interactive namespace
        ...
        try:
            ...
            # we can do is to at least restore __builtins__ for the users on
            # exit.
    ...
    def _run_with_debugger(
        ...
        try:
            ...
            # users (run by exec in pdb itself).
    ...
    def timeit(self, line='', cell=None, local_ns=None):
        ...
        instead and returns the CPU users time.
        ...
        # AST, so that we can apply our AST transformations to the users code
    ...
    def time(self,line='', cell=None, local_ns=None):
        ...
        ::
          ...
          In [1]: %time 2**128
          CPU times: users 0.00 s, sys: 0.00 s, total: 0.00 s
          Wall time: 0.00
          ...
          CPU times: users 1.20 s, sys: 0.05 s, total: 1.25 s
          Wall time: 1.37
          Out[3]: 499999500000L
        ...
        if sys.platform != "win32":
            print(
                f"CPU times: users {_format_time(cpu_user)}, sys: {_format_time(cpu_sys)}, total: {_format_time(cpu_tot)}"
            )
        else:
