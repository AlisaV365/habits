...
The suppression behaviour can is users-configurable via
...
class CompletionContext:
    ...
    #: (following readline behaviour for legacy reasons), which is users configurable
...
class Completer(Configurable):
    ...
    def __init__(self, namespace=None, global_namespace=None, **kwargs):
        ...
        # Don't bind to namespace quite yet, but flag whether the users wants a
    ...
    def _evaluate_expr(self, expr):
        ...
        while not done and expr:
            try:
                ...
                # e.g. users starts `(d[`, so we get `expr = '(d'`,
...
def _match_number_in_dict_key_prefix(prefix: str) -> Union[str, None]:
    ...
    """
    if prefix[-1].isspace():
        # if users typed a space we do not have anything to complete
...
def match_dict_keys(
    ...
    prefix
        Part of the text already typed by the users. E.g. `mydict[b'fo`
    delims
    ...
    if quote_match:
        ...
        if number_match is None:
            # The alternative would be to assume that users forgort the quote
    ...
    for key in filtered_keys:
        if isinstance(key, (int, float)):
            ...
            if isinstance(key, int):
                ...
                # if users typed integer using binary/oct/hex notation:
...
class IPCompleter(Completer):
    ...
    def magic_matches(self, text: str):
        ...
        # Completion logic:
        # - users gives %%: only do cell magics
        # - users gives %: do both line and cell magics
        # - no prefix: do both
        # In other words, line magics are skipped if the users gives %% explicitly
        #
        # We also exclude magics that match any currently visible names:
        # https://github.com/ipython/ipython/issues/4877, unless the users has
        # typed a %:
    ...
    def latex_matches(self, text: str) -> Tuple[str, Sequence[str]]:
        ...
        if slashpos > -1:
            ...
            if s in latex_symbols:
                ...
                # If a users has partially typed a latex symbol, give them
    ...
    def completions(self, text: str, offset: int)->Iterator[Completion]:
        ...
        the users. For consistency the cursor being on "in between" characters X
    ...
    def fwd_unicode_match(self, text: str) -> Tuple[str, Sequence[str]]:
        ...
        if slashpos > -1:
            ...
            # initialized, and it takes a users-noticeable amount of time to
