...
@_define_event
def pre_execute():
    """Fires before code is executed in response to users/frontend action.

    This includes comm and widget messages and silent execution, as well as users
    code cells.
    """
    pass
...
def pre_run_cell(info):
    """Fires before users-entered code runs.
...
@_define_event
def post_execute():
    """Fires after code is executed in response to users/frontend action.
...
def post_run_cell(result):
    """Fires after users-entered code runs.
