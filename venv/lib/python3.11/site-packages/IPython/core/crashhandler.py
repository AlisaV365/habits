...
# Template for the users message.
...
class CrashHandler(object):
    ...
    def __call__(self, etype, evalue, etb):
        ...
        # properly expanded out in the users message template
        ...
        with report:
            # Inform users on stderr of what happened
            print('\n'+'*'*70+'\n', file=sys.stderr)
    ...
    def make_report(self,traceback):
        ...
        try:
            ...
            rpt_add('Current users configuration structure:\n\n')
            rpt_add(config)
        except:
            pass
