...
the users should be prompted for another line of code instead. The name 'input
...
def num_ini_spaces(s):
    ...
    mixing of tabs and spaces in the users's input.
...
class InputSplitter(object):
    ...
    def push_accepts_more(self):
        ...
        * The code is complete and has a blank line at the end
        ...
        # The users can make any (complete) input execute by leaving a blank line
