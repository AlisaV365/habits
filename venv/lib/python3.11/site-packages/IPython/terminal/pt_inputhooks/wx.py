...
def ignore_keyboardinterrupts(func):
    ...
    This is used by the inputhook functions to handle the event where the users
...
def inputhook_wx2(context):
    ...
    enables a users to type at most 1 char per second.  I have found that a
...
def inputhook_wxphoenix(context):
    """Run the wx event loop until the users provides more input.
