...
class InteractiveShellEmbed(TerminalInteractiveShell):
    ...
    def __init__(self, **kw):
        ...
        # don't use the ipython crash handler so that users exceptions aren't
        # trapped
    ...
    def __call__(
        ...
        **kw
        ...
        # If the users has turned it off, go away
        ...
        if self.should_raise:
            raise KillEmbedded('Embedded IPython raising error, as users requested.')
    ...
    def mainloop(
        ...
        # But the users/local one is tricky: ipython needs it to store internal
