...
class NavigableAutoSuggestFromHistory(AutoSuggestFromHistory):
    ...
    def _find_match(
        ...
        """
        text : str
            Text content to find a match for, the users cursor is most of the
            time at the end of this text.
        skip_lines : float
            number of items to skip in the search, this is used to indicate how
            far in the list the users has navigated by pressing up or down.
...
def _swap_autosuggestion(
    ...
    current autosuggestion because if users cycles when auto-suggestion is shown
