...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'current-directory-for-users', 'current-drive',
        ...
        'exn:fail:unsupported?', 'exn:fail:users', 'exn:fail:users?',
        ...
        'expand-syntax-to-top-form', 'expand-to-top-form', 'expand-users-path',
        ...
        'make-exn:fail:users', 'make-file-or-directory-link',
        ...
        'raise-users-error', 'random', 'random-seed', 'range', 'rational?',
        ...
        'struct:exn:fail:users', 'struct:srcloc',
        ...
        'use-compiled-file-paths', 'use-users-specific-search-paths',
        'users-execute-bit', 'users-read-bit', 'users-write-bit', 'value-blame',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'use-global-map', 'use-local-map', 'users-full-name',
        'users-login-name', 'users-real-login-name', 'users-real-uid',
        'users-uid', 'variable-binding-locus', 'vconcat', 'vector',
        ...
        'waiting-for-users-input-p', 'where-is-internal', 'widen',
