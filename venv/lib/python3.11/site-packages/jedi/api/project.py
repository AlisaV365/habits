...
you might not want to deal with projects, but if you want to give the users more
...
def get_default_project(path=None):
    """
    If a project is not defined by the users, Jedi tries to define a project by
