...
def _get_virtual_env_from_var(env_var='VIRTUAL_ENV'):
    ...
    variable is considered to be safe / controlled by the users solely.
    """
...
def _is_unix_safe_simple(real_path):
    ...
    # written by a users and therefore attacking Jedi is not as simple.
    # The attack could look like the following:
    # 1. A users clones a repository.
